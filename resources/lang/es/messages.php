...
return [
    ...
    'footer' => [
        'caption' => 'En Lanex, nos dedicamos a ofrecer soluciones logísticas personalizadas y eficientes diseñadas para satisfacer las necesidades únicas de nuestros clientes. Confíe en nosotros para impulsar su negocio.',
    ...
    'home' => [
        ...
        'step' => [
            ...
            'step_2_label' => 'Paso 2',
            'step_2_title' => 'Confirma tu Envío',
            'step_2_content' => 'Confirma los detalles de tu envío y deja el resto en nuestras manos.',
            'step_3_label' => 'Paso 3',
...
Es importante que toda empresa dedicada al comercio exterior se capacite sobre la documentación, los requisitos, las normativas y otros conocimientos aduaneros que les permitan realizar sus operaciones con mayor eficiencia y seguridad.
    ...
    'supplier' => [
        'hero' => [
            'header' => 'Productos del Proveedor',
        ],
        'products' => [
            'header' => 'Encuentra Tu Producto Ideal',
            'title' => 'Revisa los Productos Más Solicitados Recientemente'
        ],
        'supplier_section' => [
    ...
    'contact' => [
        'hero' => [
            'header' => "Contáctenos",
            'title' => "Envíanos Cualquier Pregunta que Tienes",
            'form' => [
                'contact_form_title' => 'Envíanos un mensaje con cualquier pregunta, y te responderemos lo antes posible',
                'contact_form_email_label' => 'Correo Electrónico',
                'contact_form_email_placeholder' => 'Correo Electrónico',
                'contact_form_company_label' => 'Nombre de la Empresa',
                'contact_form_company_placeholder' => 'Nombre de la Empresa',
                'contact_form_ruc_label' => 'RUC',
                'contact_form_ruc_placeholder' => 'RUC',
                'contact_form_message_label' => 'Mensaje',
                'contact_form_message_placeholder' => 'Mensaje',
    ...
    'track' => [
        'hero' => [
            'title' => 'Rastrea Cualquier Pedido',
            'input_placeholder' => 'ID del Pedido',
            'input_button' => 'Buscar'
        ],
        'order' => [
            'order_details' => 'Detalles de la Orden',
            'destiny_city' => 'Ciudad Destino',
            'shipment' => 'Trayectoria',
            ...
            'shipping' => 'Envio',
            'delivered_status' => 'Estado de Entrega',
            'delivered' => 'Entregado',
            'from' => 'Origen',
            ...
            'freight' => [
                ...
                'packages' => 'paquetes',
                'freight_id' => 'ID de la carga'
            ],
            'tracking' => [
                'tracking_of_order' => 'Seguimiento del Pedido',
                'tracking_id' => 'ID de Seguimiento',
                'status' => 'estado',
                'name' => 'nombre',
                'country' => 'país',
                'city' => 'ciudad',
                'eta' => 'hora de despacho'
            ],
        ],
        'messages' => [
    ...
    'quote' => [
        'hero' => [
            'header'=> 'Contáctenos',
            'title' => 'Envíenos su información para recibir una cotización'
        ],
        'form' => [
            'quote_form_title' => 'Envíanos tu información para recibir una cotización',
            'quote_form_full_name_label' => 'Nombre y Apellido',
            'quote_form_full_name_placeholder' => 'Ingresa tu nombre y apellido',
            'quote_form_company_label' => 'Nombre de la Empresa (Opcional)',
            'quote_form_company_placeholder' => 'Ingresa el nombre de tu empresa',
            'quote_form_email_label' => 'Correo Electrónico',
            'quote_form_email_placeholder' => 'Ingresa tu correo electrónico',
            'quote_form_cellphone_label' => 'Número de Teléfono',
            'quote_form_cellphone_placeholder' => 'Ingresa tu número de teléfono',
            'quote_form_departure_address_label' => 'Pais y dirección de origen',
            'quote_form_departure_address_placeholder' => 'Ingresa el pais y direccion de origen',
            'quote_form_arrival_address_label' => 'Pais y dirección de destino',
            'quote_form_arrival_address_placeholder' => 'Ingresa tu pais y dirección de destino',
            'quote_form_message_label' => 'Descripción del producto (nombre de los productos, cantidad de bultos, medidas)',
            'quote_form_message_placeholder' => 'Ingresa una descripcion del producto',
            'quote_form_button' => 'Solicitar Cotización',
            'validations' => [
                'full_name_required' => 'El campo de nombre y apellido es obligatorio.',
                'full_name_string' => 'El nombre y apellido debe ser una cadena válida.',
                'full_name_max' => 'El nombre y apellido no puede tener más de 255 caracteres.',
                'company_required' => 'El campo de nombre de la empresa es obligatorio.',
                'company_string' => 'El nombre de la empresa debe ser una cadena válida.',
                'company_max' => 'El nombre de la empresa no puede tener más de 255 caracteres.',
                'email_required' => 'El campo de correo electrónico es obligatorio.',
                'email_valid' => 'Por favor, ingresa una dirección de correo electrónico válida.',
                'email_max' => 'La dirección de correo electrónico no puede tener más de 255 caracteres.',
                'cellphone_required' => 'El campo de número de teléfono es obligatorio.',
                'cellphone_string' => 'El número de teléfono debe ser una cadena válida.',
                'departure_address_required' => 'El campo de país y dirección de origen es obligatorio.',
                'departure_address_string' => 'El país y dirección de origen debe ser una cadena válida.',
                'departure_address_max' => 'El país y dirección de origen no puede tener más de 255 caracteres.',
                'arrival_address_required' => 'El campo de país y dirección de destino es obligatorio.',
                'arrival_address_string' => 'El país y dirección de destino debe ser una cadena válida.',
                'arrival_address_max' => 'El país y dirección de destino no puede tener más de 255 caracteres.',
                'message_required' => 'El campo de descripción del producto es obligatorio.',
                'message_string' => 'La descripción del producto debe ser una cadena válida.',
                'message_max' => 'La descripción del producto no puede tener más de 1000 caracteres.',
            ]
        ],
        'questions' => [
            'title' => 'Preguntas Frecuentes',
        ...
        'mail' => [
            ...
            'greeting_anonymous' => '¡Hola!',
            'intro_anonymous_1' => 'Gracias por visitarnos.',
            'outro_anonymous_2' => 'Nos pondremos en contacto con usted pronto.',
            'salutation_anonymous' => '¡Gracias!',
            'subject_admin' => 'Una nueva persona intenta contactarte',
            'greeting_admin' => '¡Hola!',
            'intro_admin_1' => 'Tienes una nueva solicitud de cotización',
            'intro_admin_2' => 'Estos son los detalles',
            'intro_admin_3' => 'Nombre y  Apellido',
            'intro_admin_4' => 'Compañia',
            'intro_admin_5' => 'Correo Electrónico',
            'intro_admin_6' => 'Celular',
            'intro_admin_7' => 'Pais y direccion de origen',
            'intro_admin_8' => 'Pais y direccion de destino',
            'intro_admin_9' => 'Descripción del producto',
        ],
        'success' => '¡Tu mensaje ha sido enviado exitosamente!',
        'error' => 'Hubo un problema al enviar tu mensaje. Por favor, inténtalo de nuevo.',
    ],
    'dashboard' => [
        ...
        'home' => [
            ...
            'net_amount' => 'Importe de las Ordenes',
            'delivered_orders' => 'Registro de Ordenes',
        ...
        'web' => [
            'header' => "contenido web",
            'indications' => "Selecciona una opción para crear, actualizar o eliminar contenido web",
            'dropdown_search' => "filtro de selección",
            'empty_content' => "No hay contenido para mostrar",
            'card' => [
                'reviews' => 'reseñas',
                'services' => "servicios",
                'suppliers' => 'proveedores',
            ...
            'review' => [
                ...
                'header' => "reseñas",
                'indications' => "selecciona una opción para crear, actualizar o eliminar reseñas",
                'input_placeholder_search' => "buscar reseña",
                'button_label_search' => "buscar",
                'dropdown' => [
                    'name' => 'nombre',
                    'charge' => 'cargo',
                ...
                'form' => [
                    ...
                    'validations' => [
                        ...
                        'charge_required' => 'El campo de cargo es obligatorio.',
                        'charge_string' => 'El cargo debe ser una cadena válida.',
                        'charge_max' => 'El cargo no debe exceder de 255 caracteres.',
                        'date_review_required' => 'La fecha de la reseña es obligatoria.',
                        'date_review_date' => 'La fecha de la reseña debe tener un formato válido.',
                        'review_required' => 'El contenido de la reseña es obligatorio.',
                        'review_string' => 'El contenido de la reseña debe ser una cadena válida.',
                        'review_max' => 'El contenido de la reseña no debe exceder de 500 caracteres.',
                        ...
                        'stars_max' => 'La calificación de estrellas no debe ser mayor que 5.',
                    ],
                    'success' => [
                        'create' => 'Reseña creada con éxito',
                        'update' => 'Reseña actualizada con éxito',
                        'delete' => 'Reseña eliminada con éxito'
                    ],
                    'error' => [
                        'not_found' => "Reseña no encontrada.",
                        'validation_failed' => "Hubo errores en la presentación del formulario."
                    ],
                    'modal' => [
                        'delete_header' => "¿Estás seguro de que deseas eliminar esta Reseña?",
                        'delete_content' => "No podrás restaurar la información una vez eliminada"
                    ]
                ]
            ],
            'service' => [
                ...
                'input_placeholder_search' => "buscar servicio",
                'button_label_search' => "buscar",
                'dropdown' => [
                ...
                'form' => [
                    ...
                    'fields' => [
                        ...
                        'webcontent_header' => 'Encabezado de contenido web',
                        'webcontent_title' => 'Título de contenido web',
                        'webcontent_image' => 'Imagen de contenido web',
                        'webcontent_description' => 'Descripción de contenido web',
                        'webcontent_overview' => 'Visión general',
                        'webcontent_overview_header' => 'Encabezado de visión general',
                        'webcontent_overview_title' => 'Título de visión general',
                        'webcontent_overview_image' => 'Imagen de visión general',
                        'webcontent_overview_content_header' => 'Encabezado de contenido de visión general',
                        'webcontent_overview_content_introduction' => 'Introducción del contenido de visión general',
                        'webcontent_overview_content_content' => 'Contenido de visión general',
                        'webcontent_content_link' => 'Enlace de contenido',
                        'webcontent_content_link_header' => 'Encabezado de enlace de contenido',
                        'webcontent_content_link_title' => 'Título de enlace de contenido',
                        'webcontent_content_link_button_label' => 'Etiqueta de botón de enlace de contenido',
                        'webcontent_content_link_image' => 'Imagen de enlace de contenido',
                        'webcontent_content_link_content' => 'Contenido de enlace de contenido',
                        'webcontent_keypoints_header' => 'Encabezado de puntos clave',
                        'webcontent_keypoints_title' => 'Título de puntos clave',
                        'webcontent_keypoints_points' => 'Puntos clave',
                        'webcontent_keypoints_points_add' => 'Añadir punto clave',
                        'webcontent_keypoints_point' => 'punto clave',
                        'webcontent_keypoints_points_point_title' => 'título',
                        'webcontent_keypoints_points_point_content' => 'contenido',

                        'webcontent_faqs' => 'Preguntas frecuentes',
                        'webcontent_faqs_title' => 'Título de preguntas frecuentes',
                        'webcontent_faqs_questions_add' => 'Añadir pregunta frecuente',
                    ...
                    'placeholders' => [
                        ...
                        'short_description' => 'Ingresar descripción breve',
                        'webcontent_header' => 'Ingresar encabezado de contenido web',
                        'webcontent_title' => 'Ingresar título de contenido web',
                        'webcontent_description' => 'Ingresar descripción de contenido web',
                        'webcontent_image' => 'Ingresar imagen de contenido web',
                        'webcontent_overview_header' => 'Ingresar encabezado de visión general',
                        'webcontent_overview_header' => 'Ingresar encabezado de visión general',
                        'webcontent_overview_title' => 'Ingresar título de visión general',
                        'webcontent_overview_image' => 'Seleccionar imagen de visión general',
                        'webcontent_overview_content_header' => 'Ingresar encabezado de contenido de visión general',
                        'webcontent_overview_content_introduction' => 'Ingresar introducción del contenido de visión general',
                        'webcontent_overview_content_content' => 'Ingresar contenido de visión general',
                        'webcontent_content_link_header' => 'Ingresar encabezado de enlace de contenido',
                        'webcontent_content_link_title' => 'Ingresar título de enlace de contenido',
                        'webcontent_content_link_button_label' => 'Ingresar etiqueta de botón de enlace de contenido',
                        'webcontent_content_link_image' => 'Seleccionar imagen de enlace de contenido',
                        'webcontent_content_link_content' => 'Ingresar contenido de enlace de contenido',
                        'webcontent_keypoints_header' => 'Ingresar encabezado de puntos clave',
                        'webcontent_keypoints_title' => 'Ingresar título de puntos clave',
                        'webcontent_keypoints_points' => 'Ingresar puntos clave',
                        'webcontent_keypoints_point' => 'Ingresar punto clave',
                        'webcontent_keypoints_points_point_title' => 'Ingresar título de punto clave',
                        'webcontent_keypoints_points_point_content' => 'Ingresar contenido de punto clave',
                        'webcontent_faqs_title' => 'Ingresar título de preguntas frecuentes',
                    ...
                    'success' => [
                        ...
                        'update' => 'Servicio actualizado con éxito',
                        'delete' => 'Servicio eliminado con éxito'
                    ],
                    'error' => [
                    ...
                    'modal' => [
                        'delete_header' => "¿Estás seguro de que deseas eliminar este servicio?",
                        'delete_content' => "No podrás restaurar la información una vez eliminada"
                    ]
                ]
            ],
            'product' => [
                ...
                'input_placeholder_search' => "buscar producto",
                'button_label_search' => "buscar",
                'dropdown' => [
                    'name' => 'nombre',
                    'description' => 'descripción',
                ...
                'form' => [
                    ...
                    'modal' => [
                        'delete_header' => "¿Estás seguro de que deseas eliminar este producto?",
                        'delete_content' => "No podrás restaurar la información una vez eliminada"
                    ]
                ]
            ],
            'supplier' => [
                ...
                'input_placeholder_search' => "buscar proveedor",
                'button_label_search' => "buscar",
                'dropdown' => [
                    'name' => 'nombre',
                    'description' => 'descripción',
                ...
                'form' => [
                    ...
                    'modal' => [
                        'delete_header' => "¿Estás seguro de que deseas eliminar este proveedor?",
                        'delete_content' => "No podrás restaurar la información una vez eliminada."
                    ]
                ]
            ]
    ...
    'mail' => [
        'modal' => [
            ...
            'pdf_message' => 'Puedes adjuntar cualquier archivo PDF. (Máximo 2MB)',
            'pdf_validation_mime' => 'El archivo debe ser un documento PDF.',
            'pdf_validation_max' => 'El tamaño del archivo no debe exceder los 2MB.',
            'subject_required' => 'The email subject is required.',
            'subject_max' => 'The email subject must not exceed 255 characters.',
            'title_required' => 'The email title is required.',
            'title_max' => 'The email title must not exceed 255 characters.',
            'content_required' => 'The email content is required.',
            'content_string' => 'The email content must be a valid string.',
            'content_max' => 'The email content must not exceed 2000 characters.',
            'custom_email_header' => 'Enviar Correo',
            'custom_email_subheader' => 'Se enviara el correo con la informacion brindada abajo',
            'custom_email_subject' => 'Asunto',
            'custom_email_subject_placeholder' => 'Ingresar el asunto del correo',
            'custom_email_title' => 'Titulo',
            'custom_email_title_placeholder' => 'Ingresar el titulo del correo',
            'custom_email_content' => 'Contenido',
            'custom_email_content_placeholder' => 'Ingresar el contenido del correo',
            'custom_email_details' => 'Incluir Detalles de la Orden',
            'custom_email_btn_msg' => 'Enviar Correo'
        ],
        'common' => [
            'order_name' => 'Pedido',
