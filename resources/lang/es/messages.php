...
Es importante que toda empresa dedicada al comercio exterior se capacite sobre la documentación, los requisitos, las normativas y otros conocimientos aduaneros que les permitan realizar sus operaciones con mayor eficiencia y seguridad.
    ...
    'quote' => [
        ...
        'form' => [
            'quote_form_title' => 'Envíenos su información para recibir una cotización',
            'quote_form_number_flight_label' => 'Número de Vuelo',
            'quote_form_number_flight_placeholder' => 'Número de Vuelo',
            'quote_form_departure_date_label' => 'Fecha de Salida',
            'quote_form_departure_date_placeholder' => 'Fecha de Salida',
            'quote_form_arrival_date_label' => 'Fecha de Llegada',
            'quote_form_arrival_date_placeholder' => 'Fecha de Llegada',
            'quote_form_arrival_address_label' => 'Dirección de Entrega',
            'quote_form_arrival_address_placeholder' => 'Dirección de Entrega',
            'quote_form_supplier_identificator_label' => 'Identificador del Proveedor',
            'quote_form_supplier_identificator_placeholder' => 'Identificador del Proveedor',
            'quote_form_client_identificator_label' => 'Identificador del Cliente',
            'quote_form_client_identificator_placeholder' => 'Identificador del Cliente',
            'quote_form_product_identificator_label' => 'Identificador del Producto',
            'quote_form_product_identificator_placeholder' => 'Identificador del Producto',
            'quote_form_email_label' => 'Correo Electrónico',
            'quote_form_email_placeholder' => 'Correo Electrónico',
            'quote_form_message_label' => 'Mensaje Adicional',
            'quote_form_message_placeholder' => 'Mensaje Adicional',
            'quote_form_button' => 'Cotizar Ahora',
            'validations' => [
                'number_flight_string' => 'El número de vuelo debe ser una cadena válida.',
                'number_flight_max' => 'El número de vuelo no puede tener más de 255 caracteres.',
                'packing_list_string' => 'La lista de empaque debe ser una cadena válida.',
                'packing_list_max' => 'La lista de empaque no puede tener más de 255 caracteres.',
                'departure_date_date' => 'La fecha de salida debe ser una fecha válida.',
                'arrival_date_date' => 'La fecha de llegada debe ser una fecha válida.',
                'arrival_address_string' => 'La dirección de entrega debe ser una cadena válida.',
                'arrival_address_max' => 'La dirección de entrega no puede tener más de 255 caracteres.',
                'supplier_identifier_string' => 'El identificador del proveedor debe ser una cadena válida.',
                'supplier_identifier_max' => 'El identificador del proveedor no puede tener más de 255 caracteres.',
                'client_identifier_string' => 'El identificador del cliente debe ser una cadena válida.',
                'client_identifier_max' => 'El identificador del cliente no puede tener más de 255 caracteres.',
                'product_identifier_string' => 'El identificador del producto debe ser una cadena válida.',
                'product_identifier_max' => 'El identificador del producto no puede tener más de 255 caracteres.',
                'email_required' => 'El campo de correo electrónico es obligatorio.',
                'email_valid' => 'Por favor, ingrese una dirección de correo electrónico válida.',
                'message_required' => 'El campo de mensaje es obligatorio.',
        ...
        'mail' => [
            ...
            'intro_admin_2' => 'Estos son los detalles',
            'intro_admin_3' => 'Número de Vuelo',
            'intro_admin_4' => 'Lista de Empaque',
            'intro_admin_5' => 'Fecha de Salida',
            'intro_admin_6' => 'Fecha de Llegada',
            'intro_admin_7' => 'Dirección de Entrega',
            'intro_admin_8' => 'Identificador del Proveedor',
            'intro_admin_9' => 'Identificador del Cliente',
            'intro_admin_10' => 'Identificador del Producto',
