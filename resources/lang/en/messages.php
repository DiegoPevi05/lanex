...
It is important for every company involved in international trade to be trained in documentation, requirements, regulations, and other customs knowledge to conduct operations more efficiently and securely.'
    ...
    'supplier' => [
        ...
        'products' => [
            'header' => 'Find Your Ideal Product',
            'title' => 'Check Out the Most Requested Products Recently'
        ],
        'supplier_section' => [
    ...
    'contact' => [
        'hero' => [
            'header' => "Contact Us",
            'title' => "Send Us Any Questions You Have",
            'form' => [
                'contact_form_title' => 'Send us a message with any questions, and we will respond as soon as possible',
                ...
                'contact_form_company_placeholder' => 'Company Name',
        ...
        'mail' => [
            ...
            'intro_anonymous_1' => 'Thanks for visiting us.',
            'outro_anonymous_2' => 'We will be in touch with you soon.',
            'salutation_anonymous' => 'Thank you!',
            'subject_admin' => 'A new person is trying to contact you',
            'greeting_admin' => 'Hello!',
            'intro_admin_1' => 'Hi you got a new contact form submission',
            'intro_admin_2' => 'This are the details',
            'intro_admin_3' => 'Email',
            'intro_admin_4' => 'Company',
            'intro_admin_5' => 'Ruc',
            'intro_admin_6' => 'Message',
        ],
    ...
    'track' => [
        'hero' => [
            'title' => 'Track Any Orders',
            'input_placeholder' => 'Order ID',
            'input_button' => 'Search'
        ],
        'order' => [
            'order_details' => 'order details',
            'destiny_city' => 'City Destiny',
    ...
    'quote' => [
        'hero' => [
            'header'=> 'Contact Us',
            'title' => 'Send Us Your Information to Receive a Quote'
        ],
        'form' => [
            'quote_form_title' => 'Send Us Your Information to Receive a Quote',
            'quote_form_full_name_label' => 'Name and Surname',
            'quote_form_full_name_placeholder' => 'Enter your name and surname',
            'quote_form_company_label' => 'Company Name (Optional)',
            'quote_form_company_placeholder' => 'Enter your company name',
            'quote_form_email_label' => 'Email',
            'quote_form_email_placeholder' => 'Enter your email address',
            'quote_form_cellphone_label' => 'Cellphone Number',
            'quote_form_cellphone_placeholder' => 'Enter your cellphone number',
            'quote_form_departure_address_label' => 'Origin country and address',
            'quote_form_departure_address_placeholder' => 'Enter your origin address',
            'quote_form_arrival_address_label' => 'Destiny Address',
            'quote_form_arrival_address_placeholder' => 'Enter your destiny address',
            'quote_form_message_label' => 'Product description (products name, quantities, measures)',
            'quote_form_message_placeholder' => 'Enter any product description',
            'quote_form_button' => 'Request a Quote',
            'validations' => [
                'full_name_required' => 'The name and surname field is required.',
                'full_name_string' => 'The name and surname must be a valid string.',
                'full_name_max' => 'The name and surname may not be greater than 255 characters.',
                'company_required' => 'The company name field is required.',
                'company_string' => 'The company name must be a valid string.',
                'company_max' => 'The company name may not be greater than 255 characters.',
                'email_required' => 'The email field is required.',
                'email_valid' => 'Please enter a valid email address.',
                'email_max' => 'The email address may not be greater than 255 characters.',
                'cellphone_required' => 'The cellphone number field is required.',
                'cellphone_string' => 'The cellphone number must be a valid string.',
                'departure_address_required' => 'The origin country and address field is required.',
                'departure_address_string' => 'The origin country and address must be a valid string.',
                'departure_address_max' => 'The origin country and address may not be greater than 255 characters.',
                'arrival_address_required' => 'The destiny address field is required.',
                'arrival_address_string' => 'The destiny address must be a valid string.',
                'arrival_address_max' => 'The destiny address may not be greater than 255 characters.',
                'message_required' => 'The product description field is required.',
                'message_string' => 'The product description must be a valid string.',
                'message_max' => 'The product description may not be greater than 1000 characters.',
            ]
        ],
        'questions' => [
            'title' => 'Frequently Asked Questions',
        ...
        'mail' => [
            ...
            'subject_admin' => 'A new person is trying to contact you',
            'greeting_admin' => 'Hello!',
            'intro_admin_1' => 'Hi you got a new quote form submission',
            'intro_admin_2' => 'This are the details',
            'intro_admin_3' => 'Full Name',
            'intro_admin_4' => 'Company',
            'intro_admin_5' => 'Email',
            'intro_admin_6' => 'Cellphone',
            'intro_admin_7' => 'Origin Address',
            'intro_admin_8' => 'Destiny Address',
            'intro_admin_9' => 'Product Description',
        ],
        'success' => 'Your message has been sent successfully!',
        'error' => 'There was an issue sending your message. Please try again.',
    ],
    'dashboard' => [
        ...
        'home' => [
            ...
            'net_amount' => 'Net Amount of Orders',
        ...
        'web' => [
            ...
            'blog' => [
                'new_entity' => 'new blog',
                'header' => "blogs",
                'indications' => "select an option create, update or delete blogs",
                'input_placeholder_search' => "search blog",
                ...
                'form' => [
                    ...
                    'placeholders' => [
                        ...
                        'slug' => 'enter url-friendly slug',
                        'excerpt' => 'enter brief summary',
                        'content' => 'enter blog content',
                        'add_content' => 'add content',
                        'list_content' => 'list of contents',
                        'content_preview_header' => 'enter preview header',
                        'content_preview_content' => 'enter preview content',
                    ...
                    'modal' => [
                        'delete_header' => "Are you sure you want to delete this Blog?",
            ...
            'service' => [
                ...
                'form' => [
                    ...
                    'fields' => [
                        ...
                        'webcontent_content_link' => 'Content Link',
                        ...
                        'webcontent_keypoints_points_add' => 'Add Key Point',
                        'webcontent_keypoints_point' => 'key point',
                        'webcontent_keypoints_points_point_title' => 'title',
                        'webcontent_keypoints_points_point_content' => 'content',

                        'webcontent_faqs' => 'FAQs',
                        'webcontent_faqs_title' => 'FAQs Title',
                        'webcontent_faqs_questions_add' => 'Add FAQ',
    ...
    'mail' => [
        'modal' => [
            ...
            'pdf_message' => 'You can attach any pdf file. (Max 2MB)',
            'pdf_validation_mime' => 'The file must be a PDF document.',
            'pdf_validation_max' => 'The file size must not exceed 2MB.',
            'subject_required' => 'El asunto del correo electrónico es obligatorio.',
            'subject_max' => 'El asunto del correo electrónico no debe exceder los 255 caracteres.',
            'title_required' => 'El título del correo electrónico es obligatorio.',
            'title_max' => 'El título del correo electrónico no debe exceder los 255 caracteres.',
            'content_required' => 'El contenido del correo electrónico es obligatorio.',
            'content_string' => 'El contenido del correo electrónico debe ser una cadena de texto válida.',
            'content_max' => 'El contenido del correo electrónico no debe exceder los 2000 caracteres.',
            'custom_email_header' => 'Send Email',
            'custom_email_subheader' => 'The email will be sent with the information provided below.',
            'custom_email_subject' => 'Subject',
            'custom_email_subject_placeholder' => 'Enter the email subject',
            'custom_email_title' => 'Title',
            'custom_email_title_placeholder' => 'Enter the email title',
            'custom_email_content' => 'Content',
            'custom_email_content_placeholder' => 'Enter the email content',
            'custom_email_details' => 'Include Order Details',
            'custom_email_btn_msg' => 'Send Email',
        ],
        'common' => [
            'order_name' => 'Order',
