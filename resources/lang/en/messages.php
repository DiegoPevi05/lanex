...
It is important for every company involved in international trade to be trained in documentation, requirements, regulations, and other customs knowledge to conduct operations more efficiently and securely.'
    ...
    'quote' => [
        ...
        'form' => [
            ...
            'quote_form_number_flight_label' => 'Flight Number',
            'quote_form_number_flight_placeholder' => 'Flight Number',
            'quote_form_departure_date_label' => 'Departure Date',
            'quote_form_departure_date_placeholder' => 'Departure Date',
            'quote_form_arrival_date_label' => 'Arrival Date',
            'quote_form_arrival_date_placeholder' => 'Arrival Date',
            'quote_form_arrival_address_label' => 'Delivery Address',
            'quote_form_arrival_address_placeholder' => 'Delivery Address',
            'quote_form_supplier_identificator_label' => 'Supplier Identifier',
            'quote_form_supplier_identificator_placeholder' => 'Supplier Identifier',
            'quote_form_client_identificator_label' => 'Client Identifier',
            'quote_form_client_identificator_placeholder' => 'Client Identifier',
            'quote_form_product_identificator_label' => 'Product Identifier',
            'quote_form_product_identificator_placeholder' => 'Product Identifier',
            'quote_form_email_label' => 'Email',
            'quote_form_email_placeholder' => 'Email',
            'quote_form_message_label' => 'Aditional Message',
            'quote_form_message_placeholder' => 'Aditional Message',
            'quote_form_button' => 'Quote Now',
            'validations' => [
                'number_flight_string' => 'The flight number must be a valid string.',
                'number_flight_max' => 'The flight number may not be greater than 255 characters.',
                'packing_list_string' => 'The packing list must be a valid string.',
                'packing_list_max' => 'The packing list may not be greater than 255 characters.',
                'departure_date_date' => 'The departure date must be a valid date.',
                'arrival_date_date' => 'The arrival date must be a valid date.',
                'arrival_address_string' => 'The arrival address must be a valid string.',
                'arrival_address_max' => 'The arrival address may not be greater than 255 characters.',
                'supplier_identifier_string' => 'The supplier identifier must be a valid string.',
                'supplier_identifier_max' => 'The supplier identifier may not be greater than 255 characters.',
                'client_identifier_string' => 'The client identifier must be a valid string.',
                'client_identifier_max' => 'The client identifier may not be greater than 255 characters.',
                'product_identifier_string' => 'The product identifier must be a valid string.',
                'product_identifier_max' => 'The product identifier may not be greater than 255 characters.',
                'email_required' => 'The email field is required.',
                'email_valid' => 'Please enter a valid email address.',
                'message_required' => 'The message field is required.',
        ...
        'mail' => [
            ...
            'intro_admin_2' => 'This are the details',
            'intro_admin_3' => 'Number of Flight',
            'intro_admin_4' => 'Packing List',
            'intro_admin_5' => 'Departure Date',
            'intro_admin_6' => 'Arrival Date',
            'intro_admin_7' => 'Arrival Address',
            'intro_admin_8' => 'Supplier Identifier',
            'intro_admin_9' => 'Client Identifier',
            'intro_admin_10' => 'Product Identifier',
