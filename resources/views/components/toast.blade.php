<div id="toasts_container" class="fixed top-0 right-0 w-[400px] min-h-screen flex flex-col justify-end items-end bg-transparent z-[1000] p-4 gap-y-4 transition-all pointer-events-none">
