<div id="{{$id}}" class="w-full h-auto flex flex-row gap-x-2">
    <div class="w-3/5">
        <input name="search-input-value" class="w-full h-full border-gray-light border-2 focus:outline-none p-2 rounded-xl placeholder:text-gray-300 font-bold text-body" placeholder="{{__($placeholderInput)}}" />
    </div>
    <div class="w-1/5">
        <x-drop-down
            :id="$dropDownId"
    ...
    <div class="w-1/5">
        <button  class="on-trigger-search w-full h-full rounded-xl bg-primary hover:bg-primary-dark text-white duration-300 transition-all font-bold flex items-center justify-center gap-x-2">
