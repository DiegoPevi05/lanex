<div id="{{$id}}" class="w-full h-auto flex flex-row gap-x-2">
    ...
    <div class="w-1/5">
        <button  class="on-trigger-search w-full h-full rounded-xl bg-primary hover:bg-primary-dark text-white duration-300 transition-all font-bold flex items-center justify-center gap-x-2 capitalize">
